...
export function Header({ isAuthenticated = false, coins = 0, username = "User", referralCode, isAdmin = false, onSignOut, onSignIn, onClaimCoins, onTransferCoins, onViewHistory, onSettings }: HeaderProps) {
