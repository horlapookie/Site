...
export async function setupVite(app: Express, server: Server) {
  ...
  app.use("*", async (req, res, next) => {
    ...
    try {
      ...
      // Replace placeholder with actual origin for Open Graph meta tags
      template = template.replace(/__OG_ORIGIN__/g, origin);
...
export function serveStatic(app: Express) {
  ...
  // Cache the template in production for performance
  ...
  app.use("*", (req, res) => {
    ...
    // Replace placeholder with actual origin for Open Graph meta tags
    const html = cachedTemplate.replace(/__OG_ORIGIN__/g, origin);
